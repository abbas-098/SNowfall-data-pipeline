...
class ProcessedIncidentDaily(TransformBase):
    ...
    def transform_data(self, df):
        ...
        column_mapping = {
            ...
            'sys_updated_on_dt': ('updated_date', 'date'),
            'sys_updated_on_timestamp': ('updated_time', 'time'),
            'u_vista_dispatched_eta_dt': ('u_vista_dispatched_eta_date', 'date'),
            'u_vista_dispatched_eta_timestamp': ('u_vista_dispatched_eta_time', 'time'),
            'u_vista_offsite_dt': ('u_vista_offsite_date', 'date'),
            'u_vista_offsite_timestamp': ('u_vista_offsite_time', 'time'),
            'u_vista_onsite_dt': ('u_vista_onsite_date', 'date'),
            'u_vista_onsite_timestamp': ('u_vista_onsite_time', 'time'),
            'u_call_back_time_dt': ('u_call_back_time_date', 'date'),
            'u_call_back_time_timestamp': ('u_call_back_time_time', 'time'),
            'u_last_assignment_time_dt': ('u_last_assignment_time_date', 'date'),
            'u_last_assignment_time_timestamp': ('u_last_assignment_time_time', 'time'),
            'u_techsee_agent_session_start_time_dt': ('u_techsee_agent_session_start_time_date', 'date'),
            'u_techsee_agent_session_start_time_timestamp': ('u_techsee_agent_session_start_time_time', 'time'),
            'u_l1_5_assignment_time_dt': ('u_l1_5_assignment_time_date', 'date'),
            'u_l1_5_assignment_time_timestamp': ('u_l1_5_assignment_time_time', 'time'),
            'u_customer_escalation_time_dt': ('u_customer_escalation_time_date', 'date'),
            'u_customer_escalation_time_timestamp': ('u_customer_escalation_time', 'time'),
            'sys_created_on_dt': ('created_date', 'date'),
            'sys_created_on_timestamp': ('created_time', 'time'),
            'closed_at_dt': ('closed_date', 'date'),
            'closed_at_timestamp': ('closed_time', 'time'),
            'opened_at_dt': ('opened_date', 'date'),
            'opened_at_timestamp': ('opened_time', 'time'),
            'work_end_dt': ('work_end_date', 'date'),
            'work_end_timestamp': ('work_end_time', 'time'),
            'reopened_time_dt': ('reopened_time_date', 'date'),
            'reopened_time_timestamp': ('reopened_time_time', 'time'),
            'resolved_at_dt': ('resolved_at_date', 'date'),
            'resolved_at_timestamp': ('resolved_at_time', 'time'),
            'u_reopen_date_time_dt': ('u_reopen_date_time_date', 'date'),
            'u_reopen_date_time_timestamp': ('u_reopen_date_time', 'time'),
