...
class PreparationSysUser(TransformBase):
    ...
    def save_data(self, df):
        ...
        if self.athena_trigger:
            ...
            self.aws_instance.create_athena_delta_table('preparation', 'service_now_sys_user', save_output_path, self.athena_output_path)
