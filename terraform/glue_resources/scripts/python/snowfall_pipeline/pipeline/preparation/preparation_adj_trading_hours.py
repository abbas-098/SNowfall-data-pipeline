...
class PreparationAdjTradingHours(TransformBase):
    ...
    def __init__(self, spark, sc, glueContext):
        ...
        self.file_path = "ods/adj_trading_hours"
    ...
    def save_data(self, df):
        ...
        if self.athena_trigger:
            ...
            self.aws_instance.create_athena_delta_table('preparation', 'ods_adj_trading_hours', save_output_path, self.athena_output_path)
