...
class PreparationServiceOffering(TransformBase):
    ...
    def save_data(self, df):
        ...
        if self.athena_trigger:
            ...
            self.aws_instance.create_athena_delta_table('preparation', 'service_now_service_offering', save_output_path, self.athena_output_path)
            
        else:

            # Merge data to the Delta table
            merge_columns = ['number','sys_created_on','created_year','created_month']
